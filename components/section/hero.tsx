...
export default function Hero() {
  return (
    <div className="relative flex w-full h-full" id="hero">
      <div
      ...
      <div
        className="absolute top-10 left-10 flex flex-row space-x-2 z-30"
      >
      ...
      <div
        className="absolute top-10 right-10 flex flex-row space-x-2 z-30"
      >
        <h2 className="text-[3rem] whitespace-nowrap leading-none font-bold">
                  //
        </h2>
